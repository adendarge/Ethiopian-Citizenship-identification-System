...
public function stat_init(){
  ...
  public function gender(){
    ...
    $totalfemale = DB::table('profile')->select('gender')->where('gender','Female')->get();
      return view('kebele.user.stat.gender_stat',compact('users','totalmale','totalfemale'));
  }
    public function gender2(){
    $users = DB::table('profile')->orderBy('gender', 'asc')->get();
    $totalmale = DB::table('profile')->select('gender')->where('gender','Male')->get();
    $totalfemale = DB::table('profile')->select('gender')->where('gender','Female')->get();
      return view('kebele.user.stat.sorterstat',compact('users','totalmale','totalfemale'));
  }

  public function age(){
    $users = DB::table('profile')->get();
    $users=$users->toArray();
    return view('kebele.user.stat.age_stat',compact('users'));
    }
    ...
    return view('kebele.user.stat.marital_stat',compact('users','totalsingle','totaldivorced','totalmarried'));
  ...
  public function ethinicity(){
    ...
    return view('kebele.user.stat.ethinicity_stat',compact('users','totalamhara','totaloromiya','totalharrari','totaltigrai','totalafar','totalsomalia','totalsouthern','totalbenishangul','totalgambela'));
  ...
  public function qualification(){
    ...
    return view('kebele.user.stat.qualification_stat',compact('users','totalqualification'));
  }
  ...
  public function institution(){
    ...
    return view('kebele.user.stat.institution_stat',compact('users','totalinstitution'));
  }
  ...
  public function health(){
    ...
    $users=$users->toArray();
    return view('kebele.user.stat.health_stat',compact('users','totalhiv','totaltb','totalother'));
  }
  ...
  public function crime(){
    ...
    $totalother=$totalother->toArray();
    $users=$users->toArray();
    return view('kebele.user.stat.crime_stat',compact('users','totalmurder','totalmollify','totalother'));
  }
