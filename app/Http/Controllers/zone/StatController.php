...
public function stat_init(){
  ...
  public function gender(){
    ...
    $totalfemale = DB::table('profile')->select('gender')->where('gender','Female')->get();
      return view('zone.admin.stat.gender_stat',compact('users','totalmale','totalfemale'));
  }
    public function gender2(){
    $users = DB::table('profile')->orderBy('gender', 'asc')->get();
    $totalmale = DB::table('profile')->select('gender')->where('gender','Male')->get();
    $totalfemale = DB::table('profile')->select('gender')->where('gender','Female')->get();
      return view('zone.admin.stat.sorterstat',compact('users','totalmale','totalfemale'));
  }

  public function age(){
    $users = DB::table('profile')->get();
    $users=$users->toArray();
    return view('zone.admin.stat.age_stat',compact('users'));
    }
    ...
    return view('zone.admin.stat.marital_stat',compact('users','totalsingle','totaldivorced','totalmarried'));
  ...
  public function ethinicity(){
    ...
    return view('zone.admin.stat.ethinicity_stat',compact('users','totalamhara','totaloromiya','totalharrari','totaltigrai','totalafar','totalsomalia','totalsouthern','totalbenishangul','totalgambela'));
  ...
  public function qualification(){
    ...
    return view('zone.admin.stat.qualification_stat',compact('users','totalqualification'));
  }
  ...
  public function institution(){
    ...
    return view('zone.admin.stat.institution_stat',compact('users','totalinstitution'));
  }
  ...
  public function health(){
    ...
    $users=$users->toArray();
    return view('zone.admin.stat.health_stat',compact('users','totalhiv','totaltb','totalother'));
  }
  ...
  public function crime(){
    ...
    $totalother=$totalother->toArray();
    $users=$users->toArray();
    return view('zone.admin.stat.crime_stat',compact('users','totalmurder','totalmollify','totalother'));
  }
